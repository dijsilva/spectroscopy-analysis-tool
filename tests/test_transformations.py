...
from transformations import snv, msc, area_norm, plus_sg
import unittest
import pandas as pd
import numpy as np
...
class TestTransformation(unittest.TestCase):
    ...
    def test_msc(self):
        ...
        self.assertRaises(ValueError, msc, test1)
        self.assertRaises(ValueError, msc, test2)
        self.assertRaises(ValueError, msc, test3)
